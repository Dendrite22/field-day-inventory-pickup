...
r1.value = (
    ...
    "Photos: Photo 1 (primary) and Photo 2 (secondary detail) are available per item. "
    "GPS coordinates and map view (Google hybrid) are captured at the Parent Asset (building) level only."
)
...
DATA = [
    ...
    (100033,"BO214","Clubrooms","50 Shephard Street","Ground Floor","Store Room",
     ...
     None,None,3,"ea",900,450,1800,None,"Brownbuilt",None,None,None,"Grey","Doors showing rust and impact damage",
     650,"Contents",20),
...
for row_offset, row_data in enumerate(DATA):
    ...
    # Col 28 = Unit Rate, Col 29 = ERC, Col 30 = RUL, Col 31 = Indemnity
    unit_rate_col = get_column_letter(28)
    qty_col       = get_column_letter(16)
    erc_col       = get_column_letter(29)
    rul_col       = get_column_letter(30)
    ...
    vals = [
        ...
        comments,
        unit_rate,
        f"={unit_rate_col}{r}*{qty_col}{r}",                              # ERC = unit_rate * qty
        rul_pct,
